 ...
 * ```
 */
export declare function useClientCapability<TClient extends object>({ capability, hookName, providerHint, }: UseClientCapabilityOptions): Client<TClient>;
//# sourceMappingURL=client-capability.d.ts.map