...
| [`kit-plugin-resilient-subscriptions`](https://github.com/MayurK-cmd/kit-plugin-resilient-subscriptions)                                                            | Resilient WebSocket subscriptions with auto-reconnect, exponential backoff, and gap recovery | `resilientSubscriptions`                              | [@MayurK-cmd](https://github.com/MayurK-cmd)  |
