...
| Package                                                                       | Description                                | Exports                                                               | Maintainers                                                |
| ----------------------------------------------------------------------------- | ------------------------------------------ | --------------------------------------------------------------------- | ---------------------------------------------------------- |
| [`@solana/kora`](https://github.com/solana-foundation/kora/tree/main/sdks/ts) | Pre-configured Kora gasless relayer client | `createKitKoraClient`                                                 | [Solana Foundation](https://github.com/solana-foundation/) |
| [`@solana/pay`](https://github.com/solana-foundation/pay) _(beta)_            | Pre-configured Solana Pay clients          | `createMerchantClient`, `createWalletClient`, `createSolanaPayClient` | [Solana Foundation](https://github.com/solana-foundation/) |
...
| ------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------- | -------------------------------------- | ---------------------------------------------------------- |
| [`@solana/kora`](https://github.com/solana-foundation/kora/tree/main/sdks/ts)                                       | Kora gasless relayer client plugin                                      | `koraPlugin`                           | [Solana Foundation](https://github.com/solana-foundation/) |
| [`@solana/pay`](https://github.com/solana-foundation/pay) _(beta)_                                                  | Solana Pay merchant and wallet plugins                                  | `solanaPayMerchant`, `solanaPayWallet` | [Solana Foundation](https://github.com/solana-foundation/) |
...
| [`jito`](https://github.com/amilz/kit-helpers/tree/main/plugins/jito) _(unpublished)_                               | Jito bundle building, sending, and front-running protection             | `jitoPlugin`                           | [@amilz](https://github.com/amilz)                         |
